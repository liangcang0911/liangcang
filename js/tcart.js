//add.html界面的随机验证码生成
var odiv = document.querySelector("div[id=codenum]");
var ospan = document.querySelector("span[id=codenum]");
...
//buyroom界面的数据获取
//	var oGoods = document.querySelector('ul[id=goods]');
